package io.mosip.kernel.smsserviceprovider.sms02.constant;
...
public enum SmsPropertyConstant {
	...
	PROJECT_NAME("kernel-notification-sms"), SUFFIX_MESSAGE(" digits"), NUMBERS("numbers"), USERNAME("username"),
	PASSWORD("password"), TYPE("type"), DLR("dlr"),SOURCE("source"),DESTINATION("destination");
